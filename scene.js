...
export function initThreeScene() {
  ...
  container.appendChild(canvas);
    ...
    parallaxGroup.position.set(2.4, 0, 0); 
    ...
    const geometry = new THREE.ExtrudeGeometry(rrShape, {
      depth: 0.05, bevelEnabled: true, bevelThickness: 0.2,
      bevelSize: 0.15, bevelSegments: 16
    });
    ...
    const matBottom = createGlassMat('#00E3FF');  // Mint bottom
    ...
    tl.to(parallaxGroup.position, { x: 2.4, y: 0, z: 0, duration: 2 }, 39);
